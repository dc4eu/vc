...
type CredentialIssuerMetadataParameters struct {
	...
	BatchCredentialEndpoint string `json:"batch_credential_endpoint,omitempty" yaml:"batch_credential_endpoint,omitempty"`
	...
	CredentialIdentifiersSupported bool `json:"credential_identifiers_supported,omitempty" yaml:"credential_identifiers_supported,omitempty"`
