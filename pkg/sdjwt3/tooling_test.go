...
var (
	mockHeader              = "eyJraWQiOiJkZWZhdWx0X3NpZ25pbmdfa2V5X2lkIiwidHlwIjoidmMrc2Qtand0In0"
	...
	mockSignature           = "alrFpahQwjgaCpDpsrjwkqr3hPrw-11HTGo7oC4-3GoEh2ehXGObhUPaKDCX3P1OXxSwf7BKRBYOlTQfz7jlBg"
	mockJWT                 = fmt.Sprintf("%s.%s.%s~", mockHeader, mockBody, mockSignature)
