...
// VCAuthorizationContextColl is the collection of vc authorization contexts
type VCAuthorizationContextColl struct {
	Service *Service
...
func NewAuthorizationContextColl(ctx context.Context, collName string, service *Service, log *logger.Log) (*VCAuthorizationContextColl, error) {
	c := &VCAuthorizationContextColl{
		log:     log,
		Service: service,
	}
...
func (c *VCAuthorizationContextColl) createIndex(ctx context.Context) error {
...
func (c *VCAuthorizationContextColl) Save(ctx context.Context, doc *model.AuthorizationContext) error {
...
func (c *VCAuthorizationContextColl) Consent(ctx context.Context, query *model.AuthorizationContext) error {
...
func (c *VCAuthorizationContextColl) ForfeitAuthorizationCode(ctx context.Context, query *model.AuthorizationContext) (*model.AuthorizationContext, error) {
...
func (c *VCAuthorizationContextColl) Get(ctx context.Context, query *model.AuthorizationContext) (*model.AuthorizationContext, error) {
...
func (c *VCAuthorizationContextColl) AddToken(ctx context.Context, code string, token *model.Token) error {
