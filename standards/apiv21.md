...
| string | revocation_id | true | ID for credential revocation; If not defined by institution it should be set to document_id value after upload. Different value may be used to allow credential coupling |
| string | collect_id | false | If not defined by institution it should be set to document_id value after upload.|
