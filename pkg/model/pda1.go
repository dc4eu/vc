...
// PDA1WorkPlaceNameType is the model for the PDA1 work place name type
type PDA1WorkPlaceNameType struct {
...
// PDA1WorkPlaceAddressType is the model for the PDA1 work place address type
type PDA1WorkPlaceAddressType struct {
...
// PDA1BirthPlaceType is the model for the PDA1 birth place type
...
// PDA1Section3 is the model for the PDA1 section 3
type PDA1Section3 struct {
...
// PDA1Section4 is the model for the PDA1 section 4
type PDA1Section4 struct {
	...
	RegisteredAddress                 PDA1AddressType `json:"registeredAddress" bson:"registered_address"`
}

// PDA1Section5 is the model for the PDA1 section 5
type PDA1Section5 struct {
	WorkPlaceNames            []PDA1WorkPlaceNameType    `json:"workPlaceNames" bson:"work_place_names"`
	WorkPlaceNamesBlob        string                     `json:"workPlaceNamesBlob" bson:"work_place_names_blob"`
	WorkPlaceAddresses        []PDA1WorkPlaceAddressType `json:"workPlaceAddresses" bson:"work_place_addresses"`
...
// PDA1Section6 is the model for the PDA1 section 6
type PDA1Section6 struct {
	Name          string          `json:"name" bson:"name"`
	Address       PDA1AddressType `json:"address" bson:"address"`
