...
func (c *Coll) IDMapping(ctx context.Context, query *model.MetaData) (string, error) {
	filter := bson.M{
		...
		"meta.collect_id":       query.CollectID,
		"meta.document_type":    query.DocumentType,
		"meta.document_id":      query.DocumentID,
		"meta.uid":              query.UID,
		"meta.date_of_birth":    query.DateOfBirth,
		"meta.last_name":        query.LastName,
		"meta.first_name":       query.FirstName,
	}
...
func (c *Coll) GetDocument(ctx context.Context, attr *model.MetaData) (*model.Upload, error) {
	filter := bson.M{
		"meta.authentic_source": attr.AuthenticSource,
		"meta.document_type":    attr.DocumentType,
		"meta.document_id":      attr.DocumentID,
	}
